...
from ui_premium_emojis import (
    build_button_api_kwargs as build_ui_button_api_kwargs,
    premium_emoji,
    premiumize_text,
)
...
class MessageFormatter:
    ...
    def build_button_api_kwargs(self, style: str, emoji_key: Optional[str] = None) -> dict:
        return build_ui_button_api_kwargs(style, emoji_key)

    def premiumize_text(self, text: str) -> str:
    ...
    def format_payment_confirmation(self, username: str) -> str:
        ...
        return self.premiumize_text(f"ℹ️ @{username} оплатил.")
    ...
    def format_scoreboard(self, game: DiceGame) -> str:
        ...
        return self.premiumize_text(scoreboard)
    ...
    def format_game_result(self, game: DiceGame, winner: Optional[User], payout_amount: float, check_link: str = None) -> str:
        ...
        return self.premiumize_text(result_text)
    ...
    def get_dice_emoji(self, value: int) -> str:
        ...
        return self.premiumize_text(dice_emojis.get(value, "🎲"))
